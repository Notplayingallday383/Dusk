...
var o = (e, t) => Q(e, "name", { value: t, configurable: true }), R = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof require < "u" ? require : t)[n] }) : e)(function(e) {
...
o(D, "_getter");
var N = ["isConstructor", "isEval", "isNative", "isToplevel"], I = ["columnNumber", "lineNumber"], S = ["fileName", "functionName", "source"], ee = ["args"], te = ["evalOrigin"], F = N.concat(I, S, ee, te);
function p(e) {
...
var $, x, B, L;
async function C() {
  if (!f.IN_NODE || ($ = (await import("node:url")).default, B = await import("node:fs"), L = await import("node:fs/promises"), (await import("node:vm")).default, x = await import("node:path"), T = x.sep, typeof R < "u")) return;
  let e = B, t = await import("node:crypto"), n = await import("./__vite-browser-external-2Ng8QIWW.js"), i = await import("node:child_process"), s = { fs: e, crypto: t, ws: n, child_process: i };
...
async function Se(e = {}) {
  ...
  let n = { jsglobals: globalThis, stdin: globalThis.prompt ? () => globalThis.prompt() : void 0, args: [], env: {}, packages: [], packageCacheDir: e.packageBaseUrl, enableRunUntilComplete: true, checkAPIVersion: true, BUILD_ID: "a4189f0fe3d610ecd603639c08596362b70a34b106c58c9a93486c22df4c89a5" }, i = Object.assign(n, e);
...
//# sourceMappingURL=pyodide-BxmWtnV9.js.map
